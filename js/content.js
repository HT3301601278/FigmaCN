const allData = [
  ...
  [`Create a new file to start from scratch. You can also import images, Sketch files, PowerPoints, and PDFs.`, `创建一个新文件从头开始。可以拖拽导入图片、Sketch 文件、PowerPoint 文件和 PDF 文件。`],
  ...
  [`Created`, `创建时间`],
  [`Created by `, `创建自 `],
  [`Created by anyone`, `任何人创建`],
  [`Created by others`, `其他人创建`],
  [`Created by you`, `你创建`],
